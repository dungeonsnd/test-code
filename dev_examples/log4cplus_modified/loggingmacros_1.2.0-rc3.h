...
///////////////////////////////////////////////////////////////////
// ************ adding userLogFmt by jeffery Qiu, 2015/07 ************ 
///////////////////////////////////////////////////////////////////
...
#define LOG4CPLUS_MACRO_FMT_BODY(logger, logLevel, userLogFmt, logArgs...)          \
    LOG4CPLUS_SUPPRESS_DOWHILE_WARNING()                                \
    do {                                                                \
        log4cplus::Logger const & _l                                    \
            = log4cplus::detail::macros_get_logger (logger);            \
        if (LOG4CPLUS_MACRO_LOGLEVEL_PRED (                             \
            ...
            LOG4CPLUS_MACRO_INSTANTIATE_SNPRINTF_BUF (_snpbuf);         \
            log4cplus::tchar const * _logEvent                          \
                = _snpbuf.print (userLogFmt, logArgs);                              \
            log4cplus::detail::macro_forced_log (_l,                    \
                log4cplus::logLevel, _logEvent,                         \
                __FILE__, __LINE__, LOG4CPLUS_MACRO_FUNCTION ());       \
        }                                                               \
...
#elif defined (LOG4CPLUS_HAVE_GNU_VARIADIC_MACROS)
#define LOG4CPLUS_TRACE_FMT(logger, userLogFmt, logArgs...)                         \
    LOG4CPLUS_MACRO_FMT_BODY(logger, TRACE_LOG_LEVEL, userLogFmt, logArgs)
#endif
...
#elif defined (LOG4CPLUS_HAVE_GNU_VARIADIC_MACROS)
#define LOG4CPLUS_DEBUG_FMT(logger, userLogFmt, logArgs...)                         \
    LOG4CPLUS_MACRO_FMT_BODY(logger, DEBUG_LOG_LEVEL, userLogFmt, logArgs)
#endif
...
#elif defined (LOG4CPLUS_HAVE_GNU_VARIADIC_MACROS)
#define LOG4CPLUS_INFO_FMT(logger, userLogFmt, logArgs...)                          \
    LOG4CPLUS_MACRO_FMT_BODY(logger, INFO_LOG_LEVEL, userLogFmt, logArgs)
#endif
...
#elif defined (LOG4CPLUS_HAVE_GNU_VARIADIC_MACROS)
#define LOG4CPLUS_WARN_FMT(logger, userLogFmt, logArgs...)                          \
    LOG4CPLUS_MACRO_FMT_BODY(logger, WARN_LOG_LEVEL, userLogFmt, logArgs)
#endif
...
#elif defined (LOG4CPLUS_HAVE_GNU_VARIADIC_MACROS)
#define LOG4CPLUS_ERROR_FMT(logger, userLogFmt, logArgs...)                         \
    LOG4CPLUS_MACRO_FMT_BODY(logger, ERROR_LOG_LEVEL, userLogFmt, logArgs)
#endif
...
#elif defined (LOG4CPLUS_HAVE_GNU_VARIADIC_MACROS)
#define LOG4CPLUS_FATAL_FMT(logger, userLogFmt, logArgs...)                         \
    LOG4CPLUS_MACRO_FMT_BODY(logger, FATAL_LOG_LEVEL, userLogFmt, logArgs)
#endif
